...
//  * @param {string} _id - The restaurant ID (e.g. 'rest_1')
//  * @returns {Promise<{data: object}>}
//  */
...
//     }
//     const responce = await fetch(`${API_URL}/api/restaurants/${_id}`, { method: 'GET' }).then(res => res.json());
//     if (responce.success) {
...
//  * @param {string} _id - The table ID (e.g. 'table_1')
//  * @returns {Promise<{data: object}>}
//  */
// export const getTableById = async (_id) => {
//   try {
//     if (!_id) {
//       return Promise.resolve({ data: null });
//     }
//     const responce = await fetch(`${API_URL}/api/restaurant/${_id}/table/${_id}`, { method: 'GET' }).then(res => res.json());
//     if (responce.success) {
//       console.log("responce table", responce)
//       return Promise.resolve({ data: responce.docs });
//     }
//     return Promise.resolve({ data: null });
//   } catch (e) {
//     return Promise.resolve({ data: null });
...
//   return Promise.resolve({
//     data: menuItems.filter(i => i.restaurantId === restaurant._id)
//   });
// };
...
//   const restaurant =
//     restaurants.find(r => r._id === restaurantSlug) ||
...
//   if (!restaurantId) return Promise.resolve({ data: [] });
//   try {
//     const response = await fetch(`${API_URL}/api/restaurant/${restaurantId}/tables`, { method: 'GET' }).then(res => res.json());
//     if (response.success) {
//       console.log("response tables", response)
//       return Promise.resolve({ data: response.tables });
//     }
...
//   const mostPopularItem = mostPopularItemId ? menuItems.find(i => i._id === mostPopularItemId) : null;
...
//       mostPopularItem: mostPopularItem ? { _id: mostPopularItem._id, name: mostPopularItem.name, orderCount: maxCount } : null,
